...
mod evm_circ_benches {
    ...
    #[test]
    fn bench_evm_circuit_prover_single() {
    ...
    #[cfg_attr(not(feature = "benches"), ignore)]
    #[test]
    fn bench_evm_circuit_prover_leader() {
        let setup_prfx = crate::constants::SETUP_PREFIX;
        let proof_gen_prfx = crate::constants::PROOFGEN_PREFIX;
        let proof_ver_prfx = crate::constants::PROOFVER_PREFIX;
        // Unique string used by bench results module for parsing the result
    ...
    #[cfg_attr(not(feature = "benches"), ignore)]
    fn bench_evm_circuit_prover_worker(worker_index: usize) {
        let setup_prfx = crate::constants::SETUP_PREFIX;
        let proof_gen_prfx = crate::constants::PROOFGEN_PREFIX;
        let proof_ver_prfx = crate::constants::PROOFVER_PREFIX;
        // Unique string used by bench results module for parsing the result
    ...
    #[cfg_attr(not(feature = "benches"), ignore)]
    #[test]
    fn bench_evm_circuit_prover_worker_0() {
        bench_evm_circuit_prover_worker(0);
    }

    #[cfg_attr(not(feature = "benches"), ignore)]
    #[test]
    fn bench_evm_circuit_prover_worker_1() {
        bench_evm_circuit_prover_worker(1);
    }
}
